...
function setup(){
  ...
  mainCyclist.addAnimation("RockyCycling",mainRacerImg1);
  mainCyclist.scale=0.07;
  
  //set collider for mainCyclist
  mainCyclist.setCollider("rectangle",0,0,200,50);
...
function draw() {
  ...
  player2.addAnimation("opponentPlayer2",oppYellow2Img);
    ...
    mainCyclist.velocityY = 0;
        mainCyclist.addAnimation("SahilRunning",images/mainRacerImg2);
...
function reset(){
  ...
  mainCyclist.changeAnimation("still",mainRacerImg2);
